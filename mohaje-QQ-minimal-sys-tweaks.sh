...
#bluetooth audio problem fix, enable AptX codec
#from: https://www.areilly.com/2017/07/29/enabling-aac-and-aptx-over-bluetooth-on-macos/
#or: https://medium.com/@jimkang/enable-mac-bluetooth-aptx-without-tools-706b34e2b8a6
